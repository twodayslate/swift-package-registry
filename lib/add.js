...
const addQueue = async.queue(async function (task, callback) {
...
module.exports = function (router) {
  ...
  router.post('/add', async function (req, res) {
    ...
    if (parsedUrl.hostname === 'github.com' || parsedUrl.hostname === 'swiftpackageregistry.com' || parsedUrl.hostname === 'swiftpkg.dev') {
      ...
      if (created) {
        console.log('Newly created package', _package.info.full_name)
        ...
        console.log('adding already created package', _package.info.full_name)
